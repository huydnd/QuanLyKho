...
public class GmailSender extends AsyncTask<Void, Void, Void> {
	...
	//Constructor
	public GmailSender(Context mContext, String mEmail, String mSubject, File fileSend) {
...
//        mProgressDialog.dismiss();
		...
		Toast.makeText(mContext,"Gửi mail thành công", Toast.LENGTH_SHORT).show();
		//Show success toast
//        Toast.makeText(mContext, "Message Sent", Toast.LENGTH_SHORT).show();
	...
	protected Void doInBackground(Void... params) {
		...
		final String USERNAME = "huydnd.00@gmail.com";
		final String PASSWORD = "jcicnsqoozweirwc";
		...
		try {
			...
			messageBodyPart.setText("Báo cáo tình trạng kho");
