...
public interface DAO {
	public interface WarehouseQuery{
		...
		void readAllSuppliesWithReceiptDateByWarehouseName(String warehouseName , String suppliesName, QueryResponse<List<SuppliesByDate>> response);
...
//		void updateReceipt(Receipt receipt, QueryResponse<Boolean> response);
		void deleteReceiptByWarehouseId(int warehouseID, QueryResponse<Boolean> response);
	}
...
//		void updateExport(Export export, QueryResponse<Boolean> response);
		void deleteExportByWarehouseId(int warehouseID, QueryResponse<Boolean> response);
	}
...
//		void createListDetail(ArrayList<Detail> details, QueryResponse<Boolean> response);
		...
		void deleteDetailByReceiptId(int receiptId, QueryResponse<Boolean> response);
	}
	public interface ExDetailQuery{
		...
		void deleteExDetailByExportId(int exportId, QueryResponse<Boolean> response);
	}
