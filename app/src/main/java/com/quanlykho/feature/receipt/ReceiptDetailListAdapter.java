...
public class ReceiptDetailListAdapter extends BaseAdapter {
	...
	public ReceiptDetailListAdapter(Context context, int layout, List<SuppliesDetail> suppliesDetailList) {
	...
	public View getView(int i, View view, ViewGroup viewGroup) {
		ReceiptDetailListAdapter.ViewHolder viewHolder;
		if(view==null){
			LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			view= inflater.inflate(layout,null);
			viewHolder = new ReceiptDetailListAdapter.ViewHolder();
			...
			viewHolder= (ReceiptDetailListAdapter.ViewHolder) view.getTag();
		}
