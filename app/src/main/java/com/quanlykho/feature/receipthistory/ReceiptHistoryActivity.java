			...
			public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
				...
				switch (id) {
					...
					case R.id.nav_statistics:
						startActivity( new Intent(ReceiptHistoryActivity.this, SuppliesChartActivity.class));
						break;
					case R.id.nav_pdf:
						startActivity( new Intent(ReceiptHistoryActivity.this, CreatePdfActivity.class));
						break;
					case R.id.nav_quit:
						finishAffinity();
						break;
