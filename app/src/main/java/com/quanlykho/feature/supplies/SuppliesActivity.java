			...
			public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
				...
				switch (id) {
					...
					case R.id.nav_statistics:
						startActivity( new Intent(SuppliesActivity.this, SuppliesChartActivity.class));
						break;
					case R.id.nav_pdf:
						startActivity( new Intent(SuppliesActivity.this, CreatePdfActivity.class));
						break;
					case R.id.nav_quit:
						finishAffinity();
						break;
...
//        imageView.setImageBitmap(BitmapFactory.decodeFile(picturePath));
	...
	void delSupplies(int suppliesId) {
		suppliesQuery.deleteSupplies(suppliesId, new QueryResponse<Boolean>() {
			@Override
			public void onSuccess(Boolean data) {
				suppliesArrayList.removeAll(suppliesArrayList);
				suppliesQuery.readAllSupplies(new QueryResponse<List<Supplies>>() {
	...
	public void onDelButtonClickListenner(int position) {
		delSupplies(suppliesArrayList.get(position).getSuppliesId());
	}
